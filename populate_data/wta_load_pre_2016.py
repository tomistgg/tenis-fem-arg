...
if __name__ == "__main__":
    input_file = os.path.join(DATA_DIR, "wta_pre_2016.json")

    with open(input_file, 'r', encoding='utf-8') as f:
        raw_data = json.load(f)

    print("Step 1: Building tournament DataFrame...")
    ...
    print("Step 2: Fetching Tournament IDs from ITF...")
