    ...
    <head>
        ...
        <style>
            ...
            *:focus-visible {{ outline: 2px solid var(--c-focus-ring); outline-offset: 2px; }}
            ...
            .rtgs-lock {{ margin-left: 4px; font-size: 11px; vertical-align: baseline; }}
            ...
            async function renderRoadToGS() {{
                ...
                function _appendRoadToGSCategories(parts, list) {{
                    ...
                    order.forEach(key => {{
                        ...
                        if (!rows.length) return;
                        parts.push(`<tr class="roadtogs-separator"><td colspan="5">${{_rtgsCategoryLabel(key)}}</td></tr>`);
                        rows.forEach(t => {{
                ...
                if (nonCountable.length > 0) {{
                    ...
                    _appendRoadToGSCategories(parts, nonCountable);
                }}
